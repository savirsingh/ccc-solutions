...
// Approach in this cheese sol is to select last k
// letters and then either choose a letter that isn't
// in A or arbitrarily choose a letter (if A contains
// all letters). Then use DP to check your answer.
